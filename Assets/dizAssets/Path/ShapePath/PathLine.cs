...
public class PathLine : IPath {
	...
	public PathLine ( float x0, float y0, float z0, float x1, float y1, float z1 ){
		_x0 = x0;
		_y0 = y0;
		_z0 = z0;
		_x1 = x1;
	...
	public PathLine clone (){
		return new PathLine( _x0, _y0, _z0, _x1, _y1, _z1 );
	}
	...
	public PathVector vector (  float t   ){
		return new PathVector( _x0 + ( _x1 - _x0 ) * t, _y0 + ( _y1 - _y0 ) * t, _z0 + ( _z1 - _z0 ) * t, ( _x1 - _x0 ), ( _y1 - _y0 ), ( _z1 - _z0 ) );
	}
